...
namespace KartAppBE.DAL.Migrations
{
    ...
    [Migration("20241004130325_UpdateTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KartAppBE.BLL.Models.SessionKart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "8eb549ce-9f7d-4ee4-a872-a5af1e8ab443",
                            Name = "admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "b8dd51ee-a8b1-4147-91d9-3717dff6f4fb",
                            Name = "client",
            ...
            modelBuilder.Entity("KartAppBE.BLL.Models.LapTime", b =>
                {
                    b.HasOne("KartAppBE.BLL.Models.SessionKart", "SessionKart")
                        .WithMany()
                        .HasForeignKey("SessionKartId");

                    b.HasOne("KartAppBE.BLL.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");

                    b.Navigation("SessionKart");
